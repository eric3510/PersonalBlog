...
//    /***
//     * 插入一条文档
//     * @param model 实体(需添加tableName来确定文档名称)
//     */
//    public void insert(Object model){
//        this.getMongoOperations().insert(model, getCollectionName(model.getClass()));
//    }
//
//    /***
//     * 批量插入文档
...
//        this.getMongoOperations().save(model, getCollectionName(model.getClass()));
//    }
//
//    /***
//     * 更新符合条件的第一条文档
...
//    /***
//     * 移除model的文档
//     * @param model 将要移除的文档实例
//     * @return WriteResult
//     */
//    public WriteResult remove(Object model){
//        return this.getMongoOperations().remove(model, getCollectionName(model.getClass()));
//    }
//
//    /***
//     * 移除符合条件的文档
